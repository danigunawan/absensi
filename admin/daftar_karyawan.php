...
<div action="form.asp" class="w3-card-4">
  ...
  <div class="w3-input-group">      
    ...
    <option value="pilih"> --PILIH JABATAN--</option>
              ...
              include 'db.php';
		$result = $db->query("SELECT * FROM jabatan ");
  ...
  <div class="w3-input-group">      
   ...
   <div class="w3-input-group">      
    <label class="w3-label w3-text-brown"><b>Jenis Absen:</b></label>
     <select name="waktu_presensi" id="waktu_presensi" class="w3-input w3-border w3-sand" required="">
    <option value="pilih"> --PILIH JENIS ABSEN--</option>
              
                <?php
                #ambil barang untuk combobox
		include 'db.php';
		$result = $db->query("SELECT * FROM jenis_absen ");
