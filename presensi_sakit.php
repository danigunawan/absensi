...
<div action="form.asp" class="w3-card-4">
 ...
 <form class="form-signin" role="form" method="post" action="proses_sakit.php"  enctype="multipart/form-data">
		...
		<div class='input-group date' id='tanggal1'>
                    ...
                    <input type='text' name="mulai_sakit" class="form-control" placeholder="Tanggal dan Waktu Mulai Sakit" />
                ...
                <div class='input-group date' id='tanggal2'>
                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
                    <input type='text' name="selesai_sakit" class="form-control" placeholder="Tanggal dan Waktu Selesai Sakit" />
...
<div class="input-group">
<label for="">Upload Foto Surat Sakit</label>
<input type="file" name="data">
        ...
        <button class="btn btn-lg btn-warning btn-block" type="submit">Sakit</button>
      </form>
