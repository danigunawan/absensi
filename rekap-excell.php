...
#ambil data
$query = "SELECT nik,nama,mulai_izin,selesai_izin,foto_izin,keterangan FROM izin WHERE nik = '$nik' AND tanggal >= '$daritanggal' AND tanggal <= '$sampaitanggal' order by tanggal_masuk asc";
...
$excel->writeLabel(0, 4, "SURAT IZIN");
